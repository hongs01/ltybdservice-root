 ...
 */
public class RealStationAllLineTable {
    public static final String TABELNAME = "realStationAllLineTable";
    public static final String COLUMN_FAMILY_NAME="realStationAllLineInfo@";
    ...
    public RealStationAllLineTable(String stationId,String nowtime,int stagnantTraffic,int upNumber,int downNumber){
