package com.lantaiyuan.rtscheduling.bean;
...
public class OldGPS {
   //城市ID
	...
	//距离下一站距离
	private float toNextStopDistance;
	//距离下一站时间(单位秒)
	...
	public float getToNextStopDistance() {
		return toNextStopDistance;
	}
	public void setToNextStopDistance(float toNextStopDistance) {
